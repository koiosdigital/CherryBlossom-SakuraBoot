...
/**
  * @brief Controller Area Network (FCM32 PeliCAN-compatible)
  */

typedef struct
{
  __IO uint32_t MOD;                 /*!< Mode register,                      Address offset: 0x00 */
  __IO uint32_t CMR;                 /*!< Command register,                   Address offset: 0x04 */
  __IO uint32_t SR;                  /*!< Status register,                    Address offset: 0x08 */
  __IO uint32_t IR;                  /*!< Interrupt register (read-to-clear), Address offset: 0x0C */
  __IO uint32_t IER;                 /*!< Interrupt enable register,          Address offset: 0x10 */
  uint32_t      RESERVED0;          /*!< Reserved,                                          0x14 */
  __IO uint32_t BTR0;               /*!< Bus Timing register 0,              Address offset: 0x18 */
  __IO uint32_t BTR1;               /*!< Bus Timing register 1,              Address offset: 0x1C */
  uint32_t      RESERVED1;          /*!< Reserved,                                          0x20 */
  uint32_t      RESERVED2;          /*!< Reserved,                                          0x24 */
  uint32_t      RESERVED3;          /*!< Reserved,                                          0x28 */
  __IO uint32_t ALC;                /*!< Arbitration Lost Capture,           Address offset: 0x2C */
  __IO uint32_t ECC;                /*!< Error Code Capture,                 Address offset: 0x30 */
  __IO uint32_t EWLR;               /*!< Error Warning Limit register,       Address offset: 0x34 */
  __IO uint32_t RXERR;              /*!< Receive Error Counter,              Address offset: 0x38 */
  __IO uint32_t TXERR;              /*!< Transmit Error Counter,             Address offset: 0x3C */
  __IO uint32_t FF;                 /*!< Frame Format (TX buf / RX window),  Address offset: 0x40 */
  __IO uint32_t ID0;                /*!< Identifier byte 0 (TX/RX window),   Address offset: 0x44 */
  __IO uint32_t ID1;                /*!< Identifier byte 1 (TX/RX window),   Address offset: 0x48 */
  __IO uint32_t DATA0;              /*!< Data byte 0 (TX/RX window),         Address offset: 0x4C */
  __IO uint32_t DATA1;              /*!< Data byte 1 (TX/RX window),         Address offset: 0x50 */
  __IO uint32_t DATA2;              /*!< Data byte 2 (TX/RX window),         Address offset: 0x54 */
  __IO uint32_t DATA3;              /*!< Data byte 3 (TX/RX window),         Address offset: 0x58 */
  __IO uint32_t DATA4;              /*!< Data byte 4 (TX/RX window),         Address offset: 0x5C */
  __IO uint32_t DATA5;              /*!< Data byte 5 (TX/RX window),         Address offset: 0x60 */
  __IO uint32_t DATA6;              /*!< Data byte 6 (TX/RX window),         Address offset: 0x64 */
  __IO uint32_t DATA7;              /*!< Data byte 7 (TX/RX window),         Address offset: 0x68 */
  __IO uint32_t DATA8;              /*!< Data byte 8 (TX/RX window),         Address offset: 0x6C */
  __IO uint32_t DATA9;              /*!< Data byte 9 (TX/RX window),         Address offset: 0x70 */
  __IO uint32_t RMC;                /*!< Receive Message Counter,            Address offset: 0x74 */
  __IO uint32_t RBSA;               /*!< Receive Buffer Start Address,       Address offset: 0x78 */
  __IO uint32_t CDR;                /*!< Clock Divider register,             Address offset: 0x7C */
} CAN_TypeDef;
...
/******************************************************************************/
/*                                                                            */
/*                  Controller Area Network (FCM32 PeliCAN)                   */
/*                                                                            */
/******************************************************************************/
...
#define CAN_MOD_AFM                          ((uint32_t)0x00000008)        /*!< Acceptance Filter Mode (single filter) */
...
#define CAN_SR_TCS                           ((uint32_t)0x00000008)        /*!< Transmission Complete Status */
...
#define CAN_FF_DLC_Msk                       ((uint32_t)0x0000000F)        /*!< Data Length Code mask */
#define CAN_FF_RTR                           ((uint32_t)0x00000040)        /*!< Remote Transmission Request */
#define CAN_FF_FF                            ((uint32_t)0x00000080)        /*!< Frame Format (0=std, 1=ext) */

/* Legacy compatibility — referenced nowhere, kept to prevent compile errors */
/******************************************************************************/
/*                                                                            */
